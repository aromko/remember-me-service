...
export default function Home() {
    ...
    return (
        <MarigoldProvider theme={theme}>
            ...
            <Stack>
                <Header>
                    <Headline align="center" color="secondary">Remember me service</Headline>
                </Header>
                ...
                <Stack alignX="right">
                    <Inline space="small">
                        <Button key="addReminder" variant="ghost">
                            <MLink as={Link} href="/reminderPage">Add reminder</MLink>
                        </Button>
                        <Button variant="ghost" key="addUser">
                            <MLink as={Link} href="/userPage">Add user</MLink>
                        </Button>
                        <Button variant="primary" key="syncData" onClick={() => sendRememberMessageToBot()}
